    ...
    const calculateSubmissionTime = (submissionTime) => {
        ...
        if (submissionDate < date) {
            ...
            return <td className="py-3 text-rose-600">Nộp
                trễ {Math.abs(diffInHours)} giờ {Math.abs(diffInMinutes)} phút {Math.abs(diffInSeconds)} giây</td>;
        }
    };
    useEffect(() => {
                            ...
                            <div className="mt-4 p-4 bg-slate-200 rounded-lg shadow-md">
                                ...
                                {assignmentSubmission && !uploadedFile && assignmentSubmission.fileSubmissionUrl && (
                                    <div>
                                        ...
                                        <span
                                            className="text-blue-700 mr-4">{assignmentSubmission.fileSubmissionUrl.split('/').pop()}</span>
                                    </div>
                                )}
                        ...
                        {isStatusDropdownOpen && (
                            <table className="w-full">
                                ...
                                <tr className="border-b">
                                    ...
                                    <td className="py-3 text-gray-600">{assignmentSubmission.score ? assignmentSubmission.score : 'Chưa chấm điểm'}</td>
                                </tr>
                                <tr className="border-b">
