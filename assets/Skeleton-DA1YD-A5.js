import{ag as v,ah as C,aY as u,aZ as c,U as b,aj as k,al as w,r as x,am as S,j as R,S as $,ap as U}from"./index-CjWvOQUe.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function j(t){return v("MuiSkeleton",t)}C("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:o,height:i}=t;return U({root:["root",a,n,s&&"withChildren",s&&!o&&"fitContent",s&&!i&&"heightAuto"]},j,e)},r=u`
  0% {
    opacity: 1;
  }
