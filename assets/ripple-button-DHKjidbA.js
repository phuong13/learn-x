import{r as o,j as i}from"./index-D0u0md9i.js";function w({children:u,color:d="rgba(255, 255, 255, 0.3)",duration:n=500,className:f,...m}){const[e,c]=o.useState([]),a=o.useRef(null),r=o.useRef(0),h=t=>{const l=a.current;if(!l)return;const s=l.getBoundingClientRect(),p=t.clientX-s.left,x=t.clientY-s.top,g=Math.max(s.width,s.height)*2,R={x:p,y:x,size:g,id:r.current};r.current=r.current+1,c([...e,R])};return o.useEffect(()=>{if(e.length>0){const t=setTimeout(()=>{c(e.slice(1))},n);return()=>clearTimeout(t)}},[e,n]),i.jsxs("button",{ref:a,className:`py-2 px-4  bg-gradient-to-br from-[#5BCEC9] to-[#14919B]
